    ...
    public void mostrarCursos(ArrayList<Curso> cursos) {
        ...
        for (Curso curso : cursos) {
            ...
            */
            ...
            InicioProfesor ventanaProfe = this;
            boton.addActionListener(new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent e) {
                    ventanaProfe.getControlador().mostrarVentana(TipoVentana.Ventana.VENTANA_CURSO);
                    ventanaProfe.getControlador().getControladorVentanas().setCodigoCursoActual(curso.getCodigo());                    
                    ventanaProfe.getControlador().getControladorVentanas().llenarInfoCurso();
                }
            });
