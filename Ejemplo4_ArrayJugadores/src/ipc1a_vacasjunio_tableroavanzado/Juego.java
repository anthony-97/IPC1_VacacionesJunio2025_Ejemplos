...
public class Juego {
    ...
    public static void generarLaberinto(Scanner scanner) {
        scanner.nextLine();  //Para consumir el salto de línea pendiente, que se deja despues del nextInt
        System.out.println("Ingresa tu nombre: ");
        String nombre = scanner.nextLine();        
        System.out.println("Nombre " + nombre);
        Jugadores.jugadores[Jugadores.contJugadores][0] = nombre;
        Jugadores.jugadores[Jugadores.contJugadores][1] = "";
        
        //Se aumenta el contador de jugadores
        Jugadores.contJugadores++;
        ...
        while (jugando) {
            ...
            if (Tablero.movimientoValido(tablero, nuevaFila, nuevaCol)) {
                if (tablero[nuevaFila][nuevaCol] == 'S') {
                    ...
                    int puntaje = random.nextInt(100);
                    Jugadores.jugadores[Jugadores.contJugadores-1][1] = Integer.toString(puntaje);
