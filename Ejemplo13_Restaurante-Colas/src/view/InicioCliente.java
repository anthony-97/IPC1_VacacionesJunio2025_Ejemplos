...
public class InicioCliente extends VentanaBase {
    ...
    private void botonPedidosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonPedidosActionPerformed
        // TODO add your handling code here:
        this.getControlador().getClienteActual().getVentanaPlatillosCliente().setVisible(true);
        this.getControlador().getClienteActual().llenarListaPlatillos();
        this.getControlador().getClienteActual().vaciarTabla();
